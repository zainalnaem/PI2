...
public class unterklasse_abstrakteKlasse extends abstrakteKlasse {

	int[] GM;

	// Konstruktor, der zusätzlich ein Element wert enthält
	public unterklasse_abstrakteKlasse(int size, int wert) {
	...
	public void Mengenkomplement() {
		for (int i = 0; i < mengenArray.length; i++) {
			mengenArray[i] = (byte) (1 - mengenArray[i]);
		}
	}
